(function() {
            ...
            btnStartRecording.onclick = function(event) {
                ...
                document.querySelector('#upload-to-server').innerHTML = "Upload to Server";
                ...
                recorderType = null;
                type = 'video';
                // setmediaContainerFormat.value = 'vp9';
            ...
            var MY_DOMAIN = 'sinarmasmsiglife.co.id';
            ...
            function saveToDiskOrOpenNewTab(recordRTC) {
                ...
                document.querySelector('#upload-to-server').parentNode.style.display = 'block';
                ...
                if(isMyOwnDomain()) {
                    document.querySelector('#upload-to-server').disabled = true;
                    document.querySelector('#upload-to-server').style.display = 'none';
                }
                else {
                ...
                formData.append('video-blob', blob);
                 ...
                 $.ajax({
                    ...
                    success: function(response) {
                        ...
                        alert("Video has been uploaded to server");
                        document.querySelector('#upload-to-server').innerHTML = "Video Uploaded";
                    },
            ...
            function getFileName(fileExtension) {
                ...
                return 'AJSRecord-' + year + month + date + '-' + getRandomString() + '.' + fileExtension;
            }
